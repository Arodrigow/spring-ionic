package com.spring.springionic.services.validation.utils;

//SOURCE: https://github.com/adrianoluis/misc-tools/blob/master/src/main/java/net/adrianoluis/tools/util/DocumentUtil.java
public class BR {
    // CPF
